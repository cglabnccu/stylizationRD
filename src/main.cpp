...
wxBEGIN_EVENT_TABLE(MyFrame, wxFrame)
	...
	EVT_BUTTON(BUTTON_UNDO, MyFrame::OnUndo)
	EVT_BUTTON(BUTTON_REDO, MyFrame::OnRedo)
	...
	EVT_CHOICE(COMBOBOX_GRADIENT_S_TYPE, MyFrame::OnGradientSizeTypeBox)
	EVT_CHOICE(COMBOBOX_GRADIENT_k_TYPE, MyFrame::OnGradientkTypeBox)
